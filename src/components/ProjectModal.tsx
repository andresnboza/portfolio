  ...
  return (
    <div className="modal-backdrop" onClick={e => e.target === e.currentTarget && onClose()} role="dialog" aria-modal>
      <div className="modal" ref={modalRef}>
        ...
        <button className="modal__close modal__close--desktop" onClick={onClose} aria-label="Close">
        ...
        <div className="modal__mobile-bar">
          <span className="modal__drag-pill" />
          <button className="modal__mobile-close" onClick={onClose} aria-label="Close">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
              <line x1="18" y1="6" x2="6" y2="18" />
              <line x1="6" y1="6" x2="18" y2="18" />
            </svg>
